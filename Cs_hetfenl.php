...
$lnk='<span class="l"><a href="Cs_het.php"  class="btn radius"><img border=0 src=im/zhuy.png> 合同管理</a></span> <span class="r"><a href="xExcel_Meetlx.php"  title="导出数据到Excel表" class="btn radius"><img border=0 src=im/daoc.png>&nbsp;&nbsp; 导&nbsp;&nbsp;出</a> <a href="JavaScript:openwindow2(\'xPrint_NoCountdis.php\',850,500)" title="打印当页数据" class="btn radius"><img border=0 src=im/dy.png>&nbsp;&nbsp;打&nbsp;&nbsp;印</a> </span> ';
$cha='';
$lie=",序,编号,合同类型,含合同数,禁用,修改";
