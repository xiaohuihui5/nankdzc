...
<![endif]-->
<title>欢迎<?php echo $_SESSION['uname'];?>登陆业务管理系统</title>
...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div ><font size="6" face="隶书" color="#F5F5F5">深圳市中用软件科技有限公司</font>
		...
		<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
			<ul class="cl">
				<li ><font size="4" face="华文楷体"><?php echo $_SESSION['ubummc'];?>:</font></li>
