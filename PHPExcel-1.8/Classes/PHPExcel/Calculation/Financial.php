...
class PHPExcel_Calculation_Financial
{
     ...
     * COUPDAYBS
     *
     * Returns the number of days from the ning of the coupon period to the settlement date.
     *
     * Excel Function:
     ...
     *                            Payment periods are numbered ning with 1.
     ...
     * at the ning of the depreciation (as opposed to linear depreciation). The
     ...
     * @param    int        $type    Payment type: 0 = at the end of each period, 1 = at the ning of each period
     * @return    float
     */
     ...
     *                                         The first payment is optional and corresponds to a cost or payment that occurs at the ning of the investment.
     ...
     *                                         The first payment date indicates the ning of the schedule of payments.
