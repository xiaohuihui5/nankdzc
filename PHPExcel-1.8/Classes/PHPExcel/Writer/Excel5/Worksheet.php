...
//        if ($this->firstColumnIndex > 255) $this->firstColumnIndex = 255;
    ...
    /**
     * Add data to the ning of the workbook (note the reverse order)
...
//            if ($row + 1 > 65536 or $column + 1 > 256) {
     ...
     * @param array $arrcRun Index to Font record and characters ning
     */
    ...
    private function writeFormula($row, $col, $formula, $xfIndex, $calculatedValue)
    {
        ...
        // Strip the '=' or '@' sign at the ning of the formula string
        if ($formula{0} == '=') {
