...
$tit='查询统计 <span class="c-gray en">&gt;</span> 合同信息';
...
$lnk='<span class="l"><a href="Cs_het.php"  class="btn radius"><img border=0 src=im/zhuy.png> 合同管理</a></span> ';
$lnk.='<span class="r">';
//if($menuright>1)//录入
...
$cha='';
$lie=',序,合同分类,编号,合同名称,合作企业,合作单位,合同金额,对方联系人,联系电话,起始日期,结束日期,签订日期,状态,详情,财务提醒';
$wid=',4%,8%,6%,10%,10%,8%,5%,7%,8%,7%,7%,7%,5%,4%,4%';
