...
<td><nav class="breadcrumb xhxp"><a class="btn radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><img border=0 src=./im/refresh.png></a>{$tis}</nav></td></tr>
