...
<div class="i_footer">销售月报表数据查询</div>
...
<div class="notice_front">
	<div id="news">
		<div class="i_c">
			...
			<div class="i_cont">
<?php
$TJ=" and dh.lx=2 and dh.dhrq between '".$_SESSION['DT1']."' and '".$_SESSION['DT2']."' ";
...
$macm="select 0,right(convert(varchar(10),dh.dhrq,120),5),cast(sum(sj.songhl*sj.chengbdj) as decimal(9,2)),cast(sum(sj.shisje) as decimal(9,2)),cast(sum(sj.jiesje) as decimal(9,2)),cast(sum(sj.songhl*sj.zhuangdj) as decimal(9,2)) from sys_jhdh dh,sys_jhsj sj,sys_unit unit,sys_cp cp where dh.unit=unit.id and sj.mc=cp.id and dh.id=sj.dhid $TJ group by dh.dhrq having sum(sj.shisje)>0 order by ".$_POST['lie'].$_POST['sx'];;
$macm.="#"."2,0,1,1,1,1";//前面2表示隔2个开始合计,后面如果是1表示要合计
$macm.="#".",,,,,";//百分比
$macm.="#".",center,right,right,right,right";
$macm.="#".",日期,成本,销售,结算,专柜";
$macm.="#".",2,3,4,5,6";//排序
$macm.="#";
