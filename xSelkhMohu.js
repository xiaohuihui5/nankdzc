...
mOffsetParent = mOffsetParent.offsetParent;
		...
		div.style.top=mOffsetTop+32+"px";
		div.style.left=document.getElementById("spdm").offsetLeft+0+"px";
		...
		switch (event.keyCode) {
				case 38: //up
					if(now_index<1)
					{
						...
						document.getElementById("lstab").rows[now_index].bgColor="#F2F2F2";
					...
					{
						document.getElementById("lstab").rows[now_index-1].bgColor="#F2F2F2";
				...
				case 40: //down
					...
					{
						document.getElementById("lstab").rows[0].bgColor="#F2F2F2";
						document.getElementById("lstab").rows[now_index].bgColor="";
						now_index=0;
						document.getElementById("spdm").value=document.getElementById("lstab").rows[now_index].cells[0].innerText+document.getElementById("lstab").rows[now_index].cells[1].innerText;
					}
